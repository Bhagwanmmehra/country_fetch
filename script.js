...
//   const population = Number(countryData.population/1000000).toFixed(2);

//   const name = countryData.name.common;

//   const region = countryData.region;

//   const language = Object.values(countryData.language).join(",");

//   const countryCard = document.createElementsByTagname("article");
//   countryCard.classList.add("country_card");
//   countryCard.innerHTML= `
//             <span class="token">COUNTRY 1</span>
//             <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgKRZPmpFH2XlLOzoDC0FEbLYcMibxdOXhSA&s" alt="" class="country_card_img">
